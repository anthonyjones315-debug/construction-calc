  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "We're actively building HVAC load, duct sizing, deck material, stair stringer, paint coverage, and electrical load calculators. Use the feedback button to request a specific calculator — we prioritize based on what contractors actually need."
      },
    ]
  }
]
  ...
  return (
    <div style={{ borderBottom: '1px solid ' + C.border }}>
      ...
      >
        ...
        <span style={{
          fontSize: '20px', color: C.accent, flexShrink: 0, lineHeight: 1,
      ...
      {open && (
        <div style={{
          fontSize: '14px', color: C.textMid, lineHeight: '1.75',
          paddingBottom: '20px', fontFamily: font,
        }}>
          {a}
        </div>
      )}
  ...
  return (
    <div style={{ minHeight: '100vh', background: C.bg, fontFamily: font }}>
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 24px' }}>
        ...
        {FAQS.map(cat => (
          <div key={cat.category} style={{ marginBottom: '48px' }}>
            <h2 style={{
              ...
              marginBottom: '4px', fontFamily: fontDisplay,
            }}>
              {cat.category}
            </h2>
            <div>
        ...
        {/* Don't see your question CTA */}
        <div style={{
          background: C.navBg, borderRadius: '10px',
          ...
          <div style={{ fontSize: '14px', color: '#c4bfb4', marginBottom: '20px', lineHeight: '1.6' }}>
            Send it through our feedback form — we add new answers regularly.
          </div>
          <button
            onClick={onFeedback}
            style={{
              ...
              fontSize: '14px', fontFamily: fontDisplay, letterSpacing: '1px',
