...
const SEO_MAP: Record<string, SEOConfig> = {
  ...
  blog: {
    title: "Construction Tips & Guides | Build Calc Pro Blog",
    description:
  ...
  faq: {
    ...
    description:
      "Frequently asked questions about construction calculators, material estimates, and using Build Calc Pro.",
  },
  about: {
  ...
  privacy: {
    ...
    description:
      "Privacy policy for Build Calc Pro. Learn how we handle your data.",
  },
};
