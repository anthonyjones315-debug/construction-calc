...
describe("formatters utils", () => {
  describe("getCacheKey", () => {
    ...
    it("generates deterministic keys with sorted options", () => {
      const options1 = { style: "currency" as const, currency: "USD" };
      const options2 = { currency: "USD", style: "currency" as const };
  ...
  describe("getNumberFormatter", () => {
    ...
    it("formats numbers correctly as USD", () => {
      const formatter = getNumberFormatter({ style: "currency" as const, currency: "USD" });
  ...
  describe("Pre-defined formatters", () => {
    ...
    it("DATE_FORMATTER_FULL formats date fully", () => {
      const date = new Date(2026, 2, 17); // Month index 2 is March. This constructs the date locally to avoid timezone shifts.
    ...
    it("DATE_FORMATTER_WITH_WEEKDAY formats date with weekday", () => {
      const date = new Date(2026, 2, 17); // March 17, 2026 is Tuesday. Constructs locally to avoid timezone shifts.
    ...
    it("DATE_FORMATTER_SHORT_DATE formats date in short format", () => {
      const date = new Date(2026, 2, 17); // Constructs locally to avoid timezone shifts.
    ...
    it("DATE_TIME_FORMATTER formats date and time correctly", () => {
      const date = new Date(2026, 2, 17, 12, 0, 0); // Constructs locally to avoid timezone shifts.
