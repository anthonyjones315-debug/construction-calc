...
/**
 * Pre-hoisted formatters for the most common use cases to bypass Map lookups.
 * Benchmarking shows this is ~4x faster than Map-based caching and ~75x faster
 * than inline instantiation.
 */
