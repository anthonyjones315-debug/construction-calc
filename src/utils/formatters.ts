...
/**
 * Common pre-configured formatters for performance.
 * These are hoisted to avoid repeated calls to getNumberFormatter/getDateTimeFormatter
 * and to provide a consistent formatting style across the application.
 */
