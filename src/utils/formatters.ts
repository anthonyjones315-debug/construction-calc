...
/**
 * Hoisted formatters for common use cases to avoid expensive instantiation
 * and Map-based cache lookups.
 */
...
export const DATE_FORMATTER_WEEKDAY = new Intl.DateTimeFormat("en-US", {
  weekday: "long",
  month: "short",
  day: "numeric",
});
