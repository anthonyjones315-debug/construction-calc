    ...
    <CalculatorShell results={results}>
      <InputGroup label="Pour Type">
        <ToggleGroup
          label="Type"
          value={concrete.type}
          onChange={v => updateConcrete({ type: v as 'slab' | 'footing' | 'forms' })}
  ...
  return (
    <CalculatorShell results={results}>
      ...
      <InputGroup label="Material">
        <ToggleGroup
          label="Type" value={roofing.type} onChange={v => updateRoofing({ type: v as 'shingles' | 'metal' })} options={[{ value: 'shingles', label: 'Shingles' }, { value: 'metal', label: 'Metal' }]} />
      </InputGroup>
  ...
  return (
    <CalculatorShell results={results}>
      ...
      <InputGroup label="Type">
        <SelectInput value={insulation.type} onChange={v => updateInsulation({ type: v as 'batt' | 'sprayfoam' | 'cellulose-blown' | 'cellulose-dense' })} options={[{ value: 'batt', label: 'Fiberglass Batt' }, { value: 'sprayfoam', label: 'Spray Foam' }, { value: 'cellulose-blown', label: 'Cellulose Blown-In' }, { value: 'cellulose-dense', label: 'Cellulose Dense-Pack' }]} />
      </InputGroup>
      ...
      <InputGroup label="Stud Size">
        <ToggleGroup
          label="Type" value={insulation.studSize} onChange={v => updateInsulation({ studSize: v as '2x4' | '2x6' })} options={[{ value: '2x4', label: '2×4' }, { value: '2x6', label: '2×6' }]} />
      </InputGroup>
...
export function SprayFoamCalc() {
  ...
  return (
    <CalculatorShell results={results}>
      ...
      <InputGroup label="Type">
        <ToggleGroup
          label="Type" value={sprayfoam.type} onChange={v => updateSprayFoam({ type: v as 'closed' | 'open' })} options={[{ value: 'closed', label: 'Closed-Cell' }, { value: 'open', label: 'Open-Cell' }]} />
      </InputGroup>
  ...
  return (
    <CalculatorShell results={results}>
      ...
      <InputGroup label="Application">
        <ToggleGroup
          label="Type" value={cellulose.type} onChange={v => updateCellulose({ type: v as 'attic' | 'dense-pack' })} options={[{ value: 'attic', label: 'Attic Blown' }, { value: 'dense-pack', label: 'Dense-Pack' }]} />
      </InputGroup>
  ...
  return (
    <CalculatorShell results={results}>
      ...
      <InputGroup label="Number of Coats">
        <ToggleGroup
          label="Type" value={String(paint.coats) as '1' | '2' | '3'} onChange={v => updatePaint({ coats: parseInt(v) })} options={[{ value: '1', label: '1 Coat' }, { value: '2', label: '2 Coats' }, { value: '3', label: '3 Coats' }]} />
      </InputGroup>
  ...
  return (
    <CalculatorShell results={results}>
      ...
      <InputGroup label="Voltage">
        <ToggleGroup
          label="Type" value={String(wireGauge.voltage) as '120' | '240'} onChange={v => updateWireGauge({ voltage: parseInt(v) as 120 | 240 })} options={[{ value: '120', label: '120V' }, { value: '240', label: '240V' }]} />
      </InputGroup>
      ...
      <InputGroup label="Wire Material">
        <ToggleGroup
          label="Type" value={wireGauge.material} onChange={v => updateWireGauge({ material: v as 'copper' | 'aluminum' })} options={[{ value: 'copper', label: 'Copper' }, { value: 'aluminum', label: 'Aluminum' }]} />
      </InputGroup>
    </CalculatorShell>
  )
}
