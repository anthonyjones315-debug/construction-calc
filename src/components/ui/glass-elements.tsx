...
export function ProInput({
  ...
  const inputAndSelectContent = (
    <div
      data-valid={isValid ? "true" : "false"}
      className="glass-input-shell relative flex min-h-[3.5rem] items-stretch overflow-hidden rounded-xl p-0 w-full"
    >
      <input
        id={fieldId}
        type={type}
