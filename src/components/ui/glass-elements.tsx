          ...
          <div className="flex items-center justify-between gap-2">
            ...
            {onCopyOrder ? (
              <GlassButton
                ...
                onClick={handleCopy}
                className={cx(
                  "inline-flex min-h-7 items-center gap-1 rounded-lg border-[--color-border] px-2 py-1 text-xs font-bold uppercase tracking-widest transition-colors duration-200 hover:border-primary/40",
                  copied ? "text-primary" : "text-copy-secondary",
                )}
              >
                {copied ? (
                  <>
