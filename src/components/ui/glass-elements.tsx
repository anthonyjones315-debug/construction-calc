          ...
          <div className="flex items-center justify-between gap-2">
            ...
            {onCopyOrder ? (
              <GlassButton
                ...
                className={`min-h-7 rounded-lg border-[--color-border] px-2 py-1 text-xs font-bold uppercase tracking-widest transition-colors duration-200 hover:border-primary/40 ${
                  copied
