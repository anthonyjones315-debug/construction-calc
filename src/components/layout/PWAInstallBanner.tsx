...
export function PWAInstallBanner() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-3xl items-center justify-between gap-3 rounded-2xl border border-[--color-blue-dark]/60 bg-blue-brand px-4 py-3 shadow-[0_12px_28px_rgba(0,0,0,0.4)] sm:max-w-7xl sm:rounded-2xl">
        {isIOS ? (
          <>
