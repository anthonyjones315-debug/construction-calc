  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  <body>
    <div class="page">
      ...
      <span style="display:none;color:#ea580c;">${payload.material_list ? payload.material_list.map((item) => String(item).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#039;")).join(", ") : ""}</span>
      </main>
    </div>
