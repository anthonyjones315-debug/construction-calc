...
export function generateInvoiceHtml(input: InvoiceTemplateInput): string {
  ...
  const sanitizedSignatureUrl = sanitizeUrl(signature?.signatureDataUrl);
    ...
    <div class="page">
      ...
      <div style="display: flex; justify-content: space-between; align-items: flex-start; padding-bottom: 20px; border-bottom: 3px solid #2563eb;">
        <div style="display: flex; align-items: center; gap: 12px;">
          ${
            sanitizedLogoUrl
              ? `<img src="${escapeHtml(sanitizedLogoUrl)}" alt="" style="width: 48px; height: 48px; border-radius: 8px; object-fit: contain; border: 1px solid #e5e7eb;" />`
      ...
      <div style="margin-top: 24px; padding: 16px; background: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px;">
        <p style="font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; color: #9ca3af; margin-bottom: 8px;">Recommended Materials</p>
      ...
      <div style="margin-top: 32px; display: flex; gap: 24px;">
        <div style="flex: 1;">
          ...
          <div style="border: 1px solid #e5e7eb; border-radius: 8px; padding: 8px; background: #ffffff;">
            <img src="${escapeHtml(sanitizedSignatureUrl)}" alt="Signature" style="height: 48px; object-fit: contain;" />
          </div>
        ...
        ${
          quoteNote
            ? `<section class="glass-panel px-5 py-4">
               ...
               <p class="mt-1 text-sm text-white/90 whitespace-pre-line">${escapeHtml(quoteNote)}</p>
             </section>`
            : ""
        }
