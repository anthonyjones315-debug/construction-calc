...
export const CALCULATORS: Calculator[] = [
  ...
  // Insulation
  { id: 'insulation',     label: 'Batt Insulation',      category: 'insulation',  emoji: '🧶', blurb: 'R-value, packs, coverage', seoBlurb: 'Estimate fiberglass batt insulation packs for walls and ceilings by R-value and stud size.' },
  ...
  // Budget
  { id: 'unitConverter',   label: 'Unit Converter',       category: 'labor',       emoji: '🔄', blurb: 'Length, area, volume, weight', seoBlurb: 'Convert construction units — length, area, volume, weight, temperature, and pressure.' },
...
export const CATEGORIES: Category[] = [
  ...
  { id: 'insulation', label: 'Insulation', emoji: '🧶', calculators: ['insulation', 'sprayfoam', 'cellulose'] },
  ...
  { id: 'labor',      label: 'Labor',      emoji: '👷', calculators: ['labor', 'budget', 'unitConverter'] },
]
