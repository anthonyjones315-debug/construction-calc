...
export const CATEGORIES = [
  {
    ...
    icon: '▪',
    accentColor: '#e8820c',
    photo: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=320&q=75&auto=format&fit=crop',
    blurb: 'Slab volume, footing quantities, cubic yards, bag counts — everything before the truck rolls.',
    calcs: [
      {
        id: 'slab',
        label: 'Slab Volume',
        emoji: '🧱',
        blurb: 'Cubic yards + 80 lb bag count for any flat slab. Includes 10% waste and metric conversion.',
        photo: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=280&q=75&auto=format&fit=crop',
        fields: [
        ...
        seoBlurb: 'Calculate how much concrete you need for any flat slab. Enter length, width, and thickness to get cubic yards, cubic feet, bag count, and metric equivalents — all with a built-in 10% waste factor.',
      },
      {
        id: 'footing',
        label: 'Footing Volume',
        emoji: '🏗️',
        blurb: 'Strip or continuous footing concrete volume in cubic yards. Add waste with one click.',
        photo: 'https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=280&q=75&auto=format&fit=crop',
        fields: [
        ...
        seoBlurb: 'Estimate concrete volume for strip footings and continuous footings. Enter length, width, and depth in feet or inches — get cubic yards with optional waste factor.',
      },
    ],
  },

  {
    ...
    icon: '⬜',
    accentColor: '#1a6e3f',
    photo: 'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=320&q=75&auto=format&fit=crop',
    blurb: 'Stud counts, rafter lengths, and plate material for any wall or roof frame.',
    calcs: [
      {
        id: 'studs',
        label: 'Wall Studs',
        emoji: '🔩',
        blurb: 'Stud count for any wall at 16" or 24" OC. Includes plates and board-foot estimate.',
        photo: 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=280&q=75&auto=format&fit=crop',
        fields: [
        ...
        seoBlurb: 'Calculate studs for a framed wall at 16" or 24" on-center spacing. Returns total count, 10% waste buffer, board feet of lumber, and plate linear footage.',
      },
      {
        id: 'rafters',
        label: 'Rafter Length',
        emoji: '📐',
        blurb: 'True rafter length from span and pitch. Returns ridge height and roof angle too.',
        photo: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=280&q=75&auto=format&fit=crop',
        fields: [
        ...
        seoBlurb: 'Get exact rafter length from building span, roof pitch, and overhang. Also returns ridge height and roof angle — all in one calculation.',
      },
    ],
  },

  {
    ...
    icon: '◻',
    accentColor: '#1a5f8a',
    photo: 'https://images.unsplash.com/photo-1558618047-f4e90d8b0e2c?w=320&q=75&auto=format&fit=crop',
    blurb: 'Floor area, wall area, room volume, paint gallons, and triangular sections.',
    calcs: [
      {
        id: 'room',
        label: 'Room Area',
        emoji: '📏',
        blurb: 'Floor area, all-wall square footage, room volume, paint gallons, and flooring estimate.',
        photo: 'https://images.unsplash.com/photo-1484154218962-a197022b5858?w=280&q=75&auto=format&fit=crop',
        fields: [
        ...
        seoBlurb: 'Calculate floor area, total wall area, room volume, paint gallons needed, and flooring square footage with 10% waste — all from three dimensions.',
      },
      {
        id: 'triangle',
        label: 'Triangle Area',
        emoji: '📐',
        blurb: 'Area of any triangular surface — gable ends, hip roof sections, odd-shaped lots.',
        photo: 'https://images.unsplash.com/photo-1518780664697-55e3ad937233?w=280&q=75&auto=format&fit=crop',
        fields: [
        ...
        seoBlurb: 'Find area, hypotenuse, and perimeter of any right triangle. Perfect for gable ends, hip sections, and angled lot calculations.',
      },
    ],
  },

  {
    ...
    accentColor: '#6b3d9a',
    photo: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=320&q=75&auto=format&fit=crop',
    blurb: 'Brick counts, drywall sheets, and masonry estimates with mortar and waste built in.',
    calcs: [
      {
        id: 'brick',
        label: 'Brick Calculator',
        emoji: '🧱',
        blurb: 'Bricks and mortar for any wall. Accounts for joint size and standard waste factor.',
        photo: 'https://images.unsplash.com/photo-1599707367072-cd6ada2bc375?w=280&q=75&auto=format&fit=crop',
        fields: [
        ...
        seoBlurb: 'Enter wall dimensions and brick size to get exact brick count, wall area, and per-square-foot rate — with joint size and 10% waste factored in.',
      },
      {
        id: 'drywall',
        label: 'Drywall Sheets',
        emoji: '🪵',
        blurb: '4×8 or 4×12 sheet count for any wall area. Includes 12% waste for cuts and seams.',
        photo: 'https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=280&q=75&auto=format&fit=crop',
        fields: [
        ...
        seoBlurb: 'Calculate how many drywall sheets you need for any wall or ceiling area. Supports 4×8 and 4×12 sheets with 12% waste for cuts and waste.',
      },
    ],
  },

  {
    ...
    accentColor: '#c49a00',
    photo: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=320&q=75&auto=format&fit=crop',
    blurb: 'Wire gauge, ampacity, and voltage drop — NEC-based results for any circuit.',
    calcs: [
      {
        id: 'wire',
        label: 'Wire & Ampacity',
        emoji: '⚡',
        blurb: 'Load to amperage, wire gauge, breaker size, and NEC 3% voltage drop check in one shot.',
        photo: 'https://images.unsplash.com/photo-1621905251918-48416bd8575a?w=280&q=75&auto=format&fit=crop',
        fields: [
          { id: 'load',     label: 'Load',                 unit: 'watts', placeholder: 'e.g. 1800' },
          { id: 'voltage',  label: 'Voltage',              unit: 'V',     placeholder: '120 or 240', default: 120 },
          { id: 'distance', label: 'Run Distance (1-way)', unit: 'ft',    placeholder: 'e.g. 50' },
        ...
        formula: (v) => {
          ...
          return {
            ...
            extras: [
              ...
              { label: 'Voltage Drop', value: vDrop.toFixed(2) + ' V (' + vPct.toFixed(1) + '%)' },
              { label: 'NEC 3% Limit', value: pass ? '✓ Pass' : '✗ Exceeds 3%', status: pass ? 'green' : 'red' },
            ],
          };
        },
        seoBlurb: 'Enter watts, voltage, run distance, and power factor. Get amperage draw, wire gauge, breaker size, and an NEC 3% voltage drop pass/fail check.',
      },
    ],
  },

  {
    ...
    accentColor: '#c45000',
    photo: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=320&q=75&auto=format&fit=crop',
    blurb: 'Spray foam board feet, R-value, kit count, and blown-in cellulose bag estimates.',
    calcs: [
      {
        id: 'sprayfoam',
        label: 'Spray Foam',
        emoji: '💨',
        blurb: 'Board feet, R-value, kit count, and installed cost for open-cell or closed-cell foam.',
        photo: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=280&q=75&auto=format&fit=crop',
        fields: [
        ...
        formula: (v, togs) => {
          ...
          return {
            ...
            extras: [
              ...
              { label: 'Est. Installed',    value: '$' + (bf * (isCC ? 1.00 : 0.44)).toFixed(0) + ' – $' + (bf * (isCC ? 1.50 : 0.65)).toFixed(0) },
              { label: 'Vapor Barrier',     value: isCC ? 'Not Required' : 'Required' },
            ],
          };
        },
        seoBlurb: 'Calculate board feet, R-value achieved, 200 and 600 BF kit count, and installed cost range for open-cell or closed-cell spray foam insulation.',
      },
      {
        id: 'cellulose',
        label: 'Cellulose',
        emoji: '🌿',
        blurb: '30 lb bag count for blown-in attic or dense-pack wall cellulose. Targets any R-value.',
        photo: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=280&q=75&auto=format&fit=crop',
        fields: [
        ...
        formula: (v, togs) => {
          ...
          return {
            ...
            extras: [
              ...
              { label: 'Est. Material',    value: '$' + (lbs * 0.35).toFixed(0) + ' – $' + (lbs * 0.55).toFixed(0) },
            ],
          };
        },
        seoBlurb: 'Calculate 30 lb bags of blown-in cellulose for loose-blow attic or dense-pack wall installation. Enter area and target R-value — depth and weight auto-calculated.',
      },
    ],
  },

  {
    ...
    accentColor: '#b83232',
    photo: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=320&q=75&auto=format&fit=crop',
    blurb: 'Roof pitch with material guide, roofing squares, shingle bundles, and pitch factor.',
    calcs: [
      {
        id: 'pitch',
        label: 'Roof Pitch',
        emoji: '🏠',
        blurb: 'Pitch from rise/run, span, or angle. Includes material compatibility guide and pitch factor.',
        photo: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=280&q=75&auto=format&fit=crop',
        isSpecial: true,
        seoBlurb: 'Calculate roof pitch from rise & run, total span & rise, or angle in degrees. Get pitch factor, angle, compatible materials, and a link to the roofing squares calculator.',
      },
      {
        id: 'squares',
        label: 'Roofing Squares',
        emoji: '📦',
        blurb: 'Squares, bundles, and total roof area for any pitched roof with overhang and waste.',
        photo: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=280&q=75&auto=format&fit=crop',
        fields: [
        ...
        seoBlurb: 'Calculate roofing squares, total roof area, bundle count, and pitch factor for any pitched roof. Accounts for overhang on all sides with 15% waste.',
      },
    ],
  },
];
