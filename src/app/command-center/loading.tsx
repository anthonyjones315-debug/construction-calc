export default function CommandCenterLoading() {
  return (
    <div className="command-theme page-shell command-center-page-shell flex min-h-dvh flex-col overflow-hidden bg-[#0F0F10]">
      {/* Header skeleton */}
      ...
      >
        <div className="viewport-frame command-center-page-frame">
          <div className="h-full w-full overflow-hidden rounded-none border border-slate-800 bg-slate-950 xl:rounded-[30px]">
