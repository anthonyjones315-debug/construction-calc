          ...
          <div className="flex-1 space-y-3">
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-0 top-0 flex h-full items-center justify-center px-3 text-slate-400 hover:text-[--color-blue-brand] transition-colors disabled:opacity-50"
