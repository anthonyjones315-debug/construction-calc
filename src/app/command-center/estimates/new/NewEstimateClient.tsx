          ...
          <div className="flex-1 space-y-3">
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-0 top-0 flex h-full items-center justify-center px-3 text-slate-400 transition-colors hover:text-[--color-blue-brand] disabled:opacity-50"
