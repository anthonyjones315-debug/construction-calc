...
import { DATE_TIME_FORMATTER, getNumberFormatter } from "@/utils/formatters";
...
// Reuses pre-instantiated performance-optimized date formatter to prevent render GC pressure
            ...
            >
              ...
              <div className="text-right">
                <p className="text-sm font-mono font-bold text-[--color-ink]">
                  {/* Reuses cached fast-path standard number formatter to prevent per-render Intl overhead */}
                  {est.total_cost != null ? `$${getNumberFormatter().format(est.total_cost)}` : "Pending"}
                </p>
                <span
