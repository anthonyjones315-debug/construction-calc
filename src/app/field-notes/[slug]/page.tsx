...
import { getFieldNoteBySlug, FIELD_NOTES } from "../data";
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:gap-12">
            ...
            <div className="min-w-0 flex-1">
              ...
              <article className="mt-10 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
                ...
                <div className="mt-10 rounded-2xl border border-orange-200 bg-orange-50 p-5">
            ...
            >
              <div className="sticky top-24 rounded-2xl border border-orange-200 bg-orange-50 p-5 shadow-sm">
                  ...
                  {note.relatedToolLinks.map((link) => (
                    <li key={link.href}>
                      <Link
                        ...
                        className="inline-flex items-center gap-2 text-sm font-medium text-slate-900 transition-colors hover:text-orange-600"
                      >
                        <span
                ...
                <Link
                  ...
                  className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-orange-600 px-4 py-2.5 text-sm font-bold text-white transition-colors hover:bg-orange-700"
                >
                  All Calculators →
                </Link>
              </div>
