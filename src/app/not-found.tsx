    ...
    <div className="flex min-h-screen items-center justify-center bg-[--color-bg] px-4">
      <div className="w-full max-w-md text-center">
        <div className="inline-flex items-center gap-2 mb-8">
          <div className="w-8 h-8 bg-blue-brand rounded flex items-center justify-center">
        ...
        <div className="rounded-2xl border border-[--color-border] bg-[--color-surface] p-8 shadow-[0_24px_50px_rgba(0,0,0,0.06)] transition-colors">
          <div className="text-7xl font-display font-black text-blue-brand mb-4">
            404
          </div>
          ...
          <div className="space-y-3">
            <Link
              ...
              className="btn-tactile flex min-h-11 w-full items-center justify-center rounded-lg bg-blue-brand px-4 py-2.5 text-sm font-semibold text-white transition-all duration-200 hover:bg-[--color-blue-dark] active:scale-[0.98]"
            >
              Open Calculators
            </Link>
            <Link
