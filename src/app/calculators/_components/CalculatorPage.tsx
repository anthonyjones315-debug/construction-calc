...
import { calculateResults, type CalculatorResult, type CalculatorResultsBundle, type FramingMaterialKind, type WallStudSpacingMode, type WallStudHeightMode, type RoofingPitchPreset, type RoofingInputMode } from "../_lib/calculator-math";
import {
...
export function CalculatorPage({ page, closeModal }: CalculatorPageProps) {
  ...
  const calculatorResults: CalculatorResultsBundle = useMemo(() => {
    return calculateResults({
      pageCanonicalPath: page.canonicalPath,
