...
function SignUpError() {
  return (
    <div className="flex flex-col items-center gap-4 rounded-2xl border border-[--color-border] bg-[--color-surface] p-8 shadow-xl text-center max-w-sm">
      ...
      <h2 className="text-lg font-bold text-[--color-ink]">Sign-up is loading</h2>
      <p className="text-sm text-[--color-ink-mid]">
        The sign-up form is taking longer than expected. This can happen on slow connections or in certain browsers.
      </p>
      <button
